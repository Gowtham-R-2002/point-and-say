...
export function StatusBar({
    ...
    const getStatusConfig = () => {
        ...
        if (status === 'generating') return { icon: faCode, text: 'Nova Lite generating code...', color: '#3b82f6' };
        ...
        if (status === 'confirming') return { icon: faVolumeHigh, text: 'Nova Sonic confirming...', color: 'var(--accent-emerald)' };
